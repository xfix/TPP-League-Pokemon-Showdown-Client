(function ($) {
	...
	var Topbar = this.Topbar = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.$el.html('<img class="logo" src="' + Tools.resourcePrefix + 'tppleague.png" alt="TPPLeague" width="146" height="44" /><div class="maintabbarbottom"></div><div class="tabbar maintabbar"><div class="inner"></div></div><div class="userbar"></div>');
