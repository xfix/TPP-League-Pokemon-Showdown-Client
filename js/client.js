(function($) {
	...
	var RegisterPopup = this.RegisterPopup = Popup.extend({
		...
		initialize: function(data) {
			...
			buf += '<p><label class="label"><img src="' + Tools.resourcePrefix + 'sprites/bwani/lotad.gif" /></label></p>';
